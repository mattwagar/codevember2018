...
var InitDemo = function(){
    ...
    gl.vertexAttribPointer(
        ...
        gl.FALSE, 
        5 * Float32Array.BYTES_PER_ELEMENT,// Size of an individual vertex
        2 * Float32Array.BYTES_PER_ELEMENT // Offset form the beginning of a single vertex to this attribute
    );
    ...
    gl.drawArrays(gl.TRIANGLES, 0, 3); //uses all actively bound buffers which is currently only the vertex buffer
